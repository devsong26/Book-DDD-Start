...
import com.example.demo.common.event.Events;
import com.example.demo.common.jpa.EmailSetConverter;
...
public class Member {
    ...
    public void block(){
        this.blocked = true;
        Events.raise(new MemberBlockEvent(id.getId()));
    }
    ...
    public EmailSet getEmails(){return emails;}
}
