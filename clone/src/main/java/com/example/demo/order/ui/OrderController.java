...
import com.example.demo.catalog.query.product.ProductData;
import com.example.demo.catalog.query.product.ProductQueryService;
import com.example.demo.common.ValidationErrorException;
import com.example.demo.member.command.domain.MemberId;
import com.example.demo.order.command.application.NoOrderProductException;
...
import com.example.demo.order.command.application.PlaceOrderService;
